...
Page({
  ...
  loadCommunityImages() {
    const communityImages = [
      { path: '../../images/上海市第一聋哑学校.jpg', title: '上海市第一聋哑学校' },
      { path: '../../images/北京联合大学特殊教育学院.jpg', title: '北京联合大学特殊教育学院' },
      { path: '../../images/南京市聋人学校.jpg', title: '南京市聋人学校' },
      { path: '../../images/慰问聋哑学校.jpg', title: '慰问聋哑学校' },
      { path: '../../images/手语培训活动.jpg', title: '手语培训活动' },
      { path: '../../images/无声之爱康复计划.jpg', title: '无声之爱康复计划' },
      { path: '../../images/聋哑人就业指导.jpg', title: '聋哑人就业指导' },
      { path: '../../images/聋哑康复训练.jpg', title: '聋哑康复训练' }
    ];
  ...
  viewPost(e) {
    ...
    wx.navigateTo({
      url: `/subpackage_community/pages/forum_detail/forum_detail?id=${postId}`
    });
  },
  ...
  createPost() {
    wx.navigateTo({
      url: '/subpackage_community/pages/forum_create/forum_create'
    });
  },
