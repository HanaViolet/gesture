Page({
  data: {
      ...
      deafSchoolList: [
          { 
              title: '北京联合大学特殊教育学院', 
              image: '../../images/北京联合大学特殊教育学院.jpg',
              pagePath: '/pages/cowork_content/school/bj'
          },
          { 
              title: '上海市第一聋哑学校', 
              image: '../../images/上海市第一聋哑学校.jpg',
              pagePath: '/pages/cowork_content/school/sh'
          },
          { 
              title: '南京市聋人学校', 
              image: '../../images/南京市聋人学校.jpg',
  ...
  goToCommunityForum() {
    wx.navigateTo({
      url: '/subpackage_community/pages/forum/forum'
    });
  }
});    